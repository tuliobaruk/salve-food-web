...
import {
	...
	AvatarFallback,
	AvatarImage,
} from "@/components/landingPagComponents/carroussel/avatar";
...
export default function ComentarioCarroussel() {
	const comentarios = [
		...
		},
		{
			...
			comment:
				"Com a SalveFood, conseguimos alcançar muito mais clientes e aumentar a visibilidade da nossa marca.",
		...
		<Carousel className="w-full max-w-2xl mx-auto">
			...
			<div className="flex justify-between mt-4">
				<CarouselPrevious
					...
					onClick={() =>
						setActiveIndex((prevIndex) => (prevIndex - 1 + comentarios.length) % comentarios.length)
					}
				/>
				<CarouselNext
					className="bg-gray-200 hover:bg-gray-300 p-2 rounded-full"
