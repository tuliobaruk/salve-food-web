        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-md shadow-lg p-6 w-96">
            ...
            <p className="text-gray-700 mb-4">
              Tem certeza que deseja {modal.action} o pedido{" "}
              <strong>#{modal.pedido.id}</strong> de {modal.pedido.cliente}?
            </p>
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">
                      {pedido.itens.join(", ")} - <span className="font-semibold">{pedido.status}</span>
                    </p>
                  </div>
                  <span className="text-gray-400 text-sm">
                    Finalizado às {pedido.finalizadoEm}
                  </span>
                </div>
              </li>
            ))
